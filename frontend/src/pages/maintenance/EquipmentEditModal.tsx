...
interface EquipmentEditModalProps {
    ...
    onSave: (updatedEquipment: Partial<Equipment>) => void;
    categories: EquipmentCategory[];
    sites: MaintenanceSite[];
}

const EquipmentEditModal: React.FC<EquipmentEditModalProps> = ({ isOpen, onClose, equipment, onSave, categories, sites }) => {
    ...
    useEffect(() => {
        if (equipment) {
            setFormData({
                ...
                siteId: equipment.siteId || equipment.site?.id || '',
                                        ...
                                        <div className="mt-4">
                                            <form onSubmit={handleSubmit} className="space-y-4">
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div>
                                                        <label htmlFor="internalId" className="block text-sm font-medium text-gray-700">No. Système</label>
                                                        <input
                                                            type="text"
                                                            name="internalId"
                                                            id="internalId"
                                                    ...
                                                    <div>
                                                        <label htmlFor="serialNumber" className="block text-sm font-medium text-gray-700">No. Série</label>
                                                        <input
                                                            type="text"
                                                            name="serialNumber"
                                                            id="serialNumber"
