/* AGENT V5.18 - PDF PRE-COPY UPDATE */
...
// --- CONFIGURATION ---
const AGENT_VERSION = "V5.18 - PDF PRE-COPY";
...
async function processJob(filename) {
    ...
    // ACTION: DEVISPDF (PRE-COPY EXCEL TO PDF FOLDER)
    ...
    if (action === 'devispdf' && sourcePath) {
        ...
        try {
            ...
            console.log(`   📥 Copying Excel to PDF Dir: ${destExcelPath}`);
