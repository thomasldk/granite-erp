...
router.post('/refresh-exchange-rate', systemConfigController_1.refreshExchangeRate);
router.get('/exchange-rate-history', systemConfigController_1.getExchangeRateHistory);
