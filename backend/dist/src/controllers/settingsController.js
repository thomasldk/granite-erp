...
const getLanguages = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const languages = yield prisma_1.default.language.findMany({
            orderBy: { name: 'asc' }
        });
        res.json(languages);
    }
...
const deleteLanguage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prisma_1.default.language.delete({
            where: { id }
        });
        res.status(204).send();
    }
...
const createCurrency = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const currency = yield prisma_1.default.currency.create({
...
const deleteCurrency = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prisma_1.default.currency.delete({
            where: { id }
        });
        res.status(204).send();
    }
...
const getSystemSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const settings = yield prisma_1.default.setting.findMany();
