...
exports.processAgentBundle = exports.ackPendingXml = exports.downloadPendingXml = exports.listPendingXmls = exports.reviseQuote = exports.downloadQuoteResult = exports.emitQuote = exports.downloadQuotePdf = exports.fetchReturnXml = exports.processReturnXmlFile = exports.saveRakToNetwork = exports.reintegrateExcel = exports.importNetworkXml = exports.importQuoteXml = exports.exportQuoteToLocal = exports.generateQuoteXml = exports.duplicateQuote = exports.reviseQuote_LEGACY = exports.deleteQuote = exports.deleteItem = exports.addItem = exports.updateQuote = exports.createQuote = exports.getQuoteById = exports.downloadSourceExcel = exports.downloadQuoteExcel = exports.getQuotes = exports.getNextQuoteReference = exports.generatePdf = exports.generateQuoteExcel = void 0;
...
const generateQuoteExcel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.params;
    try {
        const quoteFull = yield prisma_1.default.quote.findUnique({
            where: { id: id },
            include: {
                items: true,
                project: true,
...
const generatePdf = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const projectPath = `F:\\nxerp\\${((_d = quote.project) === null || _d === void 0 ? void 0 : _d.name) || 'Projet'}`;
        // 2. Generate RAK
        const xmlContent = yield xmlService.generatePdfXml(quote, projectPath, filename);
        // 3. Save RAK
...
const downloadSourceExcel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const quote = yield prisma_1.default.quote.findUnique({ where: { id } });
...
const getQuoteById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        let quote = yield prisma_1.default.quote.findUnique({
            where: { id },
            include: {
                client: true,
                project: true,
        ...
        if (fs.existsSync(targetXmlPath)) {
            ...
            try {
                yield (0, exports.processReturnXmlFile)(id, targetXmlPath);
                ...
                quote = yield prisma_1.default.quote.findUnique({
                    where: { id },
                    include: {
                        client: true,
                        project: true,
...
const createQuote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (finalValidityDuration === null) {
            ...
            if (thirdPartyId) {
                const client = yield prisma_1.default.thirdParty.findUnique({ where: { id: thirdPartyId } });
            ...
            if (finalValidityDuration === null) {
                const config = yield prisma_1.default.systemConfig.findUnique({ where: { key: 'GLOBAL' } });
...
const updateQuote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const quote = yield prisma_1.default.quote.update({
            where: { id },
            data: {
        ...
        if (clientName || clientAddress1 || clientCity || clientState || clientZipCode || clientPhone || clientFax || clientEmail) {
            yield prisma_1.default.thirdParty.update({
...
const deleteItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield prisma_1.default.quoteItem.delete({
            where: { id: itemId }
        });
    }
    catch (error) {
...
const deleteQuote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield prisma_1.default.quoteItem.deleteMany({ where: { quoteId: id } });
        // Then delete quote
...
const reviseQuote_LEGACY = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const originalQuote = yield prisma_1.default.quote.findUnique({
            where: { id },
            include: { items: true }
        });
        if (!originalQuote)
        ...
        // 3. Create new Quote
        const newQuote = yield prisma_1.default.quote.create({
            data: {
        ...
        if (originalQuote.items.length > 0) {
            ...
            yield prisma_1.default.quoteItem.createMany({
                data: itemsData
            });
        }
    }
...
const duplicateQuote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newClient = yield prisma_1.default.thirdParty.findUnique({ where: { id: finalClientId }, include: { addresses: true, contacts: true, paymentTerm: true } });
        const newContact = finalContactId ? yield prisma_1.default.contact.findUnique({ where: { id: finalContactId } }) : null;
        ...
        let valCurrency = originalQuote.salesCurrency;
        let valExchange = originalQuote.exchangeRate;
        let valRepId = originalQuote.representativeId;
        let valSemiStandard = originalQuote.semiStandardRate;
        let valPalletPrice = originalQuote.palletPrice;
        let valPalletRequired = originalQuote.palletRequired;
        let valValidity = (_a = originalQuote.validityDuration) !== null && _a !== void 0 ? _a : 30;
        ...
        if (originalQuote.items.length > 0) {
            ...
            yield prisma_1.default.quoteItem.createMany({ data: itemsData });
        }
        // 6. Generate RAK XML
        ...
        const fullNewQuote = yield prisma_1.default.quote.findUnique({
        ...
        if (isSourceAvailable) {
            ...
            const safeNameU = (s) => (s || '').replace(/[^a-zA-Z0-9-]/g, '_');
            const safeProjectName = safeNameU(project.name);
            const basePath = 'F:\\nxerp';
            // Source Path
            const oldClientName = safeNameU((_b = originalQuote.client) === null || _b === void 0 ? void 0 : _b.name);
            const oldMaterialName = safeNameU((_c = originalQuote.material) === null || _c === void 0 ? void 0 : _c.name);
            ...
            // Target Path
            const newClientName = safeNameU((newClient === null || newClient === void 0 ? void 0 : newClient.name) || 'Unknown');
            ...
            xmlContent = yield xmlService.generateDuplicateXml(fullNewQuote, oldPath, newPath, originalQuote.reference);
            ...
            xmlContent = yield xmlService.generateQuoteXml(fullNewQuote);
...
const reintegrateExcel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        console.log(`[Reintegrate] START. ID=${id}, File=${file === null || file === void 0 ? void 0 : file.originalname}`);
        const quote = yield prisma_1.default.quote.findUnique({
            where: { id },
            include: { project: true, material: true, client: true }
        });
        ...
        const sanitizeWindows = (s) => (s || '').replace(/[<>:"/\\|?*]/g, '');
        ...
        const rakContent = yield xmlService.generateReintegrationXml(targetPathOnPC, id);
...
const processReturnXmlFile = (quoteId, targetPath) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const parsed = yield xmlService.parseExcelReturnXml(xmlContent);
    ...
    yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let updateData = { syncStatus: 'Synced' }; // Mark as Synced
        ...
        yield tx.quote.update({
            where: { id: quoteId },
            data: updateData
        });
        // 1. Delete existing items
        yield tx.quoteItem.deleteMany({ where: { quoteId: quoteId } });
        // 2. Insert new items
...
exports.processReturnXmlFile = processReturnXmlFile;
const fetchReturnXml = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updatedItems = yield (0, exports.processReturnXmlFile)(id, targetPath);
...
const emitQuote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const recipientEmail = (_a = quote.contact) === null || _a === void 0 ? void 0 : _a.email;
        if (!recipientEmail) {
        ...
        if (quote.syncStatus === 'Synced' && quote.pdfFilePath) {
            ...
            if (fs.existsSync(possiblePath)) {
                ...
                pdfBuffer = yield pdfService_1.PdfService.generateQuotePdf(quote);
            }
        }
        else {
        ...
        if (message) {
            ...
            // Fallback default
            emailHtml = `
                <p>Bonjour ${((_b = quote.contact) === null || _b === void 0 ? void 0 : _b.firstName) || 'Client'},</p>
                <p>Veuillez trouver ci-joint votre soumission <strong>${quote.reference}</strong> pour le projet <strong>${(_c = quote.project) === null || _c === void 0 ? void 0 : _c.name}</strong>.</p>
                <p>Cordialement,</p>
        ...
        const { data, error } = yield resend.emails.send({
            ...
            cc: ((_d = quote.representative) === null || _d === void 0 ? void 0 : _d.email) ? [quote.representative.email] : undefined,
            subject: subject || `Soumission pour le Projet ${((_e = quote.project) === null || _e === void 0 ? void 0 : _e.name) || quote.reference}`,
            html: emailHtml,
            attachments: [
                {
        ...
        console.log(`[EMIT] Email sent successfully! ID: ${data === null || data === void 0 ? void 0 : data.id}`);
        // 4. Update Status
        const updatedQuote = yield prisma_1.default.quote.update({
            where: { id },
            data: { status: 'Sent' }
        });
        res.json({ message: 'Quote emitted successfully', quote: updatedQuote, emailId: data === null || data === void 0 ? void 0 : data.id });
    }
    catch (error) {
...
const downloadQuoteResult = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!fs.existsSync(projectPath)) {
            ...
            return (0, exports.downloadSourceExcel)(req, res);
        }
...
const reviseQuote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let newMaterialName;
        if (materialId) {
            const mat = yield prisma_1.default.material.findUnique({ where: { id: materialId } });
            if (mat)
        ...
        const existingRev = yield prisma_1.default.quote.findUnique({ where: { reference: newReference } });
        if (existingRev) {
            ...
            yield prisma_1.default.quoteItem.deleteMany({ where: { quoteId: existingRev.id } });
            yield prisma_1.default.quote.delete({ where: { id: existingRev.id } });
        ...
        if (quoteFull) {
            ...
            // New Filename (Target)
            const newClientName = (_b = quoteFull.client) === null || _b === void 0 ? void 0 : _b.name;
            const newProjectName = (_c = quoteFull.project) === null || _c === void 0 ? void 0 : _c.name;
            const newMaterialNameUsed = (_d = quoteFull.material) === null || _d === void 0 ? void 0 : _d.name;
            ...
            const revisionData = {
                ...
                ancienCouleur: ((_e = originalQuote.material) === null || _e === void 0 ? void 0 : _e.name) || '',
                nouveauCouleur: ((_f = quoteFull.material) === null || _f === void 0 ? void 0 : _f.name) || '',
                ancienQualite: ((_g = originalQuote.material) === null || _g === void 0 ? void 0 : _g.quality) || '',
                nouvelleQualite: ((_h = quoteFull.material) === null || _h === void 0 ? void 0 : _h.quality) || ''
            };
            const xmlContent = yield xmlService.generateQuoteXml(quoteFull, rep, revisionData);
            // Save to pending_xml
            const safeRef = (str) => (str || '').replace(/[^a-zA-Z0-9- ]/g, '');
...
// --- AGENT POLLING ---
const listPendingXmls = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.listPendingXmls = listPendingXmls;
const downloadPendingXml = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.downloadPendingXml = downloadPendingXml;
const ackPendingXml = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (fs.existsSync(filePath)) {
            ...
            const quote = yield prisma_1.default.quote.findFirst({ where: { reference } });
...
exports.ackPendingXml = ackPendingXml;
const processAgentBundle = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Keep it.
        yield backupService.performBackupToDisk();
        ...
        if (quote) {
            ...
            yield prisma_1.default.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                if (items.length > 0) {
                    ...
                    yield prisma.quoteItem.createMany({ data: quotaItems });
                }
            }));
        ...
        if (excelFile) {
            ...
            if (quote) {
                const totalAmount = items.length > 0 ? items.reduce((sum, i) => sum + i.totalPrice, 0) : quote.totalAmount;
                yield prisma_1.default.quote.update({
                    where: { id: quote.id },
                    data: {
                        totalAmount,
...
exports.processAgentBundle = processAgentBundle;
