...
const getMaterialById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const material = yield prisma_1.default.material.findUnique({
            where: { id },
            include: { supplier: true }
        });
        if (!material)
...
const updateMaterial = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const material = yield prisma_1.default.material.update({
            where: { id },
            data: {
                name,
                category,
...
const deleteMaterial = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        yield prisma_1.default.material.delete({ where: { id } });
        res.status(204).send();
    }
    catch (error) {
