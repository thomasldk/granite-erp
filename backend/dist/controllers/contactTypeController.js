...
const getContactTypes = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const types = yield prisma.contactType.findMany({
            where,
            orderBy: { name: 'asc' }
        });
        res.json(types);
...
const createContactType = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const type = yield prisma.contactType.create({
            data: {
                name,
...
const updateContactType = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { name, category } = req.body;
        const type = yield prisma.contactType.update({
            where: { id },
            data: { name, category }
        });
        res.json(type);
...
const deleteContactType = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prisma.contactType.delete({
            where: { id }
        });
        res.status(204).send();
    }
