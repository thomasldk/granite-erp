...
async function main() {
    ...
    for (const line of lines) {
        ...
        const reference = ((_a = parts[1]) === null || _a === void 0 ? void 0 : _a.trim()) === 'N.R.' ? null : (_b = parts[1]) === null || _b === void 0 ? void 0 : _b.trim();
        const categoryName = (_c = parts[2]) === null || _c === void 0 ? void 0 : _c.trim();
        const location = ((_d = parts[3]) === null || _d === void 0 ? void 0 : _d.trim()) || null;
        // Min Qty (index 4)
        let minQuantity = 0;
        ...
        // Description (index 8)
        const description = ((_e = parts[8]) === null || _e === void 0 ? void 0 : _e.trim()) || null;
        // Note (index 9)
        const note = ((_f = parts[9]) === null || _f === void 0 ? void 0 : _f.trim()) || null;
        // Supplier (index 10)
        const supplier = ((_g = parts[10]) === null || _g === void 0 ? void 0 : _g.trim()) || null;
        let categoryId = null;
        if (categoryName) {
